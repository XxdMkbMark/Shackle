...
public class CollisionUtils {
    ...
    public static synchronized boolean isReCollision(Actor actor, Rectangle rectangle) {
        ...
        // 获取 演员1 缩放后的包围矩阵
        rect1.setSize(
                actor.getWidth() * actor.getScaleX(),
                actor.getHeight() * actor.getScaleY()
        );
        rect1.setPosition(
                actor.getX() - (actor.getOriginX() * actor.getScaleX() - actor.getOriginX()),
                actor.getY() - (actor.getOriginY() * actor.getScaleY() - actor.getOriginY())
        );
